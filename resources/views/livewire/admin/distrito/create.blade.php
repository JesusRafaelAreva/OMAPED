<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Distrito') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <div class="card-body">
        ...
        <div class='form-group'>
            <label for='input-nombre_distrito' class='col-sm-2 control-label'> {{ __('Distrito') }}</label>
        ...
        <!-- IdProv Input -->
        <div class='form-group'>
            <label for='input-idProv' class='col-sm-2 control-label'> {{ __('Provincias') }}</label>
