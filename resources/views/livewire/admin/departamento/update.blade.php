<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('UpdateTitle', ['name' => __('Departamento') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <form class="form-horizontal" wire:submit.prevent="update" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class='form-group'>
                <label for='input-nombre_departamento' class='col-sm-2 control-label '> {{ __('Nombre_departamento') }}</label>
