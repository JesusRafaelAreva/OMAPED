...
class Read extends Component
{
    ...
    protected $listeners = ['nucleosDeleted'];

    public $sortType;
    public $sortColumn;

    public function nucleosDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('nucleos');
        ...
        return view('livewire.admin.nucleos.read', [
            'nucleoss' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Nucleos')) ]);
    }
}
